    ...
    <>
      {trips.map((trip, index) => (
        <div
          className={`${
            index !== 0 ? "mt-2" : ""
          } hover:bg-custom-purple-dark group grid grid-cols-2 gap-4 rounded-lg border border-gray-600 bg-custom-gray-darkest p-4 hover:cursor-pointer md:grid-cols-4`}
          key={trip.id}
        >
          <div>
